...
10.times do
  ...
  puts "Create a car"
  car = Car.create(name: Faker::Vehicle.make, description: "A louer", price: Faker::Commerce.price(range: 20..70.0, as_string: true), model: Faker::Vehicle.model, user: user)
end
puts "Done"